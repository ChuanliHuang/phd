...
file_name = '/Users/kikawaryoku/Library/CloudStorage/OneDrive-UniversityofEdinburgh/shugoshin/temporary storage/Melanie2023_Red1ChIP-seq_r1/Red1_arm.xlsx'
...
selected_x = select_region(x, x, size)
selected_wt_means = select_region(x, wt_means, size)
selected_wt_lower = select_region(x, wt_lower, size)
selected_wt_upper = select_region(x, wt_upper, size)

selected_rec8_2_means = select_region(x, rec8_2_means, size)
selected_rec8_2_lower = select_region(x, rec8_2_lower, size)
selected_rec8_2_upper = select_region(x, rec8_2_upper, size)

selected_rec8_means = select_region(x, rec8_means, size)
selected_rec8_lower = select_region(x, rec8_lower, size)
selected_rec8_upper = select_region(x, rec8_upper, size)
